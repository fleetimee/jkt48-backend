...
interface RequestDeletionEmailProps {
    validationCode?: string;
}

export const RequestDeletionEmail = ({ validationCode }: RequestDeletionEmailProps) => (
    <Html>
        <Head />
        <Preview>You have submitted a request to delete your account</Preview>
        <Body style={main}>
            <Container style={container}>
                <Section style={logoContainer}>
                    <Img src={`${BASE_URL}/static/email_logo.png`} width="120" alt="Slack" />
                </Section>
                <Heading style={h1}>You have submitted a request to delete your account</Heading>{' '}
                <Text style={heroText}>
                    Below is your token for account deletion. If you did not request this, please contact us
                    immediately.
                </Text>
...
RequestDeletionEmail.PreviewProps = {
    validationCode: 'DJZ-TLX',
} as RequestDeletionEmailProps;

export default RequestDeletionEmail;
