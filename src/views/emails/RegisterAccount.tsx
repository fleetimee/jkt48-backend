...
interface RegisterAccountEmailProps {
    validationCode?: string;
}

export const RegisterAccountEmail = ({ validationCode }: RegisterAccountEmailProps) => (
    <Html>
        <Head />
        ...
        <Body style={main}>
            <Container style={container}>
                ...
                <Text style={heroText}>
                    You're almost there! Please enter the code provided below into the app to complete your
                    registration.
                </Text>
...
RegisterAccountEmail.PreviewProps = {
    validationCode: 'DJZ-TLX',
} as RegisterAccountEmailProps;
